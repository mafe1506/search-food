...
print("Mostrando detalles de todos los producto:")
db_connector.execute_stored_procedure('Detalleproducto')

print("\nActualizando un producto:")
db_connector.execute_update_procedure('Actualizarproducto', 1, 'leche de vaca', 'leche de vaca conservada en botella', '2024-08-02', '2024-09-05', '2024089')

print("\nMostrando detalles de todos los productos después de la actualización:")
db_connector.execute_stored_procedure('Detalleproducto')
